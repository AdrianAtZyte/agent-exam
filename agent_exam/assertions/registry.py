...
_REGISTRY: dict[str, CheckFn] = {
    ...
    "first_mcp_tool": first_mcp_tool.check,
    "mcp_tool_called": mcp_tool_called.check,
    "mcp_tool_not_called": mcp_tool_not_called.check,
    "judge": judge.check,
...
_MODELS: dict[str, type[BaseModel]] = {
    ...
    "first_mcp_tool": first_mcp_tool.FirstMcpToolConfig,
    "mcp_tool_called": mcp_tool_called.McpToolCalledConfig,
    "mcp_tool_not_called": mcp_tool_not_called.McpToolNotCalledConfig,
