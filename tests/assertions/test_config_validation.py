...
_VALID = [
    ...
    ("mcp_tool_called", "search"),
    ("mcp_tool_called", {"tool": "search", "arguments": {"type": "product", "n": 1}}),
    (
        "mcp_tool_called",
        {"tool": "x", "arguments": {"html": {"equals_file": "a.html"}}},
    ),
    ("mcp_tool_not_called", {"tool": "x", "arguments": {"url": {"matches": "^https"}}}),
...
_INVALID = [
    ...
    ("first_mcp_tool", {"server": "files"}, "tool"),
    ("mcp_tool_called", {"tool": ""}, "at least 1 character"),
    ("mcp_tool_called", {"tool": "x", "arguments": {"a": {}}}, "exactly one"),
    (
        "mcp_tool_called",
        {"tool": "x", "arguments": {"a": {"equals_file": "f", "matches": "m"}}},
        "exactly one",
    ),
    (
        "mcp_tool_called",
        {"tool": "x", "arguments": {"a": {"matches": "["}}},
        "invalid regex",
    ),
    (
        "mcp_tool_called",
        {"tool": "x", "arguments": {"a": {"typo": "y"}}},
        "Extra inputs",
    ),
    ("mcp_tool_not_called", {"tool": "x", "typo": 1}, "Extra inputs"),
